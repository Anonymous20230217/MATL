...
def parse_args():
    ...
    parser.add_argument('--batch_size', type=int, default=8, help='how many instances for encoding and normalization at each step')
    parser.add_argument('--chunk_size', type=int, default=60, help='split code vector into chunks and store them individually. '\
