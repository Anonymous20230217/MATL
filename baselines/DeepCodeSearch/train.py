...
def train(args):
    ...
    ckpt = f'./output/{args.model}/{args.dataset}/origin_2/models/step4000000.h5'
...
def parse_args():
    ...
    parser.add_argument('--save_every', type=int, default=300, help='interval to evaluation to concrete results')
