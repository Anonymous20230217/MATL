...
train_name_path = os.path.join(dataset_dir, 'train/train.token.name')
train_result_path = os.path.join(dataset_dir, 'train/train_ground_truth.npy')
...
valid_name_path = os.path.join(dataset_dir, 'valid/valid.token.name')
valid_result_path = os.path.join(dataset_dir, 'valid/valid_ground_truth.npy')
...
test_name_path = os.path.join(dataset_dir, 'test/test.token.name')
test_result_path = os.path.join(dataset_dir, 'test/test_ground_truth.npy')
...
# hyperparameters
vocab_min_count = 3
code_vocab_size = 13000  # 30000
nl_vocab_size = 29000   # 30000
